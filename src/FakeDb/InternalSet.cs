...
namespace FakeDb
{
    ...
    public class InternalSet : IInternalSet
    {
        ...
        public InternalSet(IIdGenerator idGenerator, ICache cache, IObjectGraph objectGraph)
        {
        ...
        void Meterialize(object item)
        {
            foreach (var obj in _objectGraph.Traverse(item))
            {
                ...
                var s = (InternalSet) _cache.For(obj.GetType());
